...
public class NodeMCUv2Cutout
{
	...
	private double pinLength = 38.0;
	private double pindWidth = 3.0;
	...
	public Geometry3D getCutout(JavaCSG csg)
	{
		...
		// Pins
		Geometry3D pin = csg.box3D(pindWidth, pinLength,pinHeight+1, false);
		...
		RoundClicker roundClicker = new RoundClicker(csg,u)
